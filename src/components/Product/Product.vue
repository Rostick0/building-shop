...
const { description, equipment, count, price } = props;
...
<template>
    <div class="cartelement_top row">
        <div class="product_photo col-6 col-sm-12">
            <div class="product_photo_slider_full swiper" thumbsSlider="">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="product_photo_slider_item swiper-slide">
                            <div class="product_photo_slider_item_photo"
                                style="background-image: url('/images/product_detail/1.jpg');"></div>
                            <div class="icons">
                                <div class="faw">
                                ...
                                <div class="compare">
                                    <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                        ...
                                        <path
                                            ...
                                            stroke="#C1C1C1" stroke-width="2" stroke-linecap="round"
                        ...
                        <div class="product_photo_slider_item swiper-slide">
                            <div class="product_photo_slider_item_photo"
                                style="background-image: url('/images/product_detail/2.jpg');"></div>
                            <div class="icons">
                                <div class="faw">
                                    <svg width="26" height="23" viewBox="0 0 26 23" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="product_photo_slider_item swiper-slide">
                            <div class="product_photo_slider_item_photo"
                                style="background-image: url('/images/product_detail/3.jpg');"></div>
                            <div class="icons">
                                <div class="faw">
                                    <svg width="26" height="23" viewBox="0 0 26 23" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="product_photo_slider_item swiper-slide">
                            <div class="product_photo_slider_item_photo"
                                style="background-image: url('/images/product_detail/4.jpg');"></div>
                            <div class="icons">
                                <div class="faw">
                                    <svg width="26" height="23" viewBox="0 0 26 23" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="product_photo_slider_smile_preview swiper">
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="product_photo_slider_smile_preview_item swiper-slide">
                            <img src="/images/product_detail/1.jpg" alt="" />
                        </div>
                        <div class="product_photo_slider_smile_preview_item swiper-slide">
                            <img src="/images/product_detail/2.jpg" alt="" />
                        </div>
                        <div class="product_photo_slider_smile_preview_item swiper-slide">
                            <img src="/images/product_detail/3.jpg" alt="" />
                        </div>
                        <div class="product_photo_slider_smile_preview_item swiper-slide">
                            <img src="/images/product_detail/4.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="cartelement_tab_content">
            <div class="cartelement_tab_content_item" :class="{ 'active': switcher === 1 }">
                <table>
                    ...
                    <tr>
                        <td>Диапазон регулирования сварочного тока в режиме MMA, А</td>
                        <td>10-200</td>
                        <td>Диапазон регулирования сварочного тока в режиме MMA, А</td>
                        <td>10-200</td>
                    </tr>
                ...
                <p>
                    <b>Fubag IRMIG 180 SYN MIG/MAG/TIG/MMA</b> - легкий и удобный аппарат, который
                    идеально подходит для неразъемного соединения металлических изделий ручной дуговой
                    сваркой или методом ТiG-сварки (в среде защитного газа). Сварочный ток удобно
                    регулируется в диапазоне 10 - 200 А нажатием кнопок "+" и "-". Цифровая индикация
                    основных рабочих параметров существенно облегчает эксплуатацию инвертора. Данная
                    модель питается от однофазной сети и выдерживает перепады напряжения от 130 до 265
                    В.Данная информация взята с сайта компании
                </p>
                <h2>Комплектация</h2>
                <p>
                    Сварочный полуавтомат – 1 шт.; Горелка 3 м – 1 шт.; Кабель заземления, медь 3 м –
                    1шт.; Кабель с электрододержателем, медь 1,6 м – 1 шт.;
                    Газовый шланг 3 м – 1 шт.; Ролик 0,6-0,8 мм – 1 шт.
                </p>
                <h2>Функции</h2>
                <p>
                    Регулировка Hot Start (горячий старт). Увеличение сварочного (импульсного) тока в
                    начальный момент для улучшения поджига дуги. Регулируется в пределах от 0 до 90%.
                    Arc Force (стабильность горения дуги). Кратковременное увеличение силы тока в момент
                    залипания электрода. Помогает капле оторваться от стержня электрода, делая тем самым
                    процесс переноса капель через дуговой промежуток четким и равномерным. Anti Sticking
                    (антиприлипание). Снижение сварочного тока для отделения залипшего электрода на
                    изделии без повреждения обмазки. TIG Lift. Ручная сварка неплавящимся вольфрамовым
                    электродом в среде защитного газа - аргона. Преимущественно используется для сварки
