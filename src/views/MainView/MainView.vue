...
const Partners = defineAsyncComponent(() => import('@/components/Partners/Partners.vue'));
const ContactsBlock = defineAsyncComponent(() => import('@/components/ContactsBlock/ContactsBlock.vue'));
</script>
